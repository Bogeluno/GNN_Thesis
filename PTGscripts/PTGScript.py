...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GCNConv(264,32, aggr = 'add'),'x, edge_index, edge_weight -> x'),
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GCNConv(264,32, aggr = 'max'),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.1), 'x -> x'),
            (Linear(32,16),'x -> x'),
            nn.ReLU(inplace = True),
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GCNConv(264,32, aggr = 'mean'),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.1), 'x -> x'),
            (Linear(32,16),'x -> x'),
            nn.ReLU(inplace = True),
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GCNConv(264,96, aggr = 'max'),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.1), 'x -> x'),
            (Linear(96,48),'x -> x'),
            nn.ReLU(inplace = True),

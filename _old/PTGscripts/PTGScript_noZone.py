...
from torch_geometric.nn import Sequential, GCNConv, GATConv, GraphConv, TopKPooling, Linear
...
def make_PTG(graph, zones):
    ...
    # drop
    attr.drop(columns=['park_location_lat', 'park_location_long', 'leave_location_lat', 'leave_location_long', 'leave_zone', 'park_fuel', 'park_zone', 'moved', 'movedTF', 'time', 'prev_customer', 'next_customer'], inplace = True)
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GCNConv(8,32, aggr = 'add'),'x, edge_index, edge_weight -> x'),
    ...
    def forward(self, data):
        ...
        x = self.seq(x, edge_index, edge_weight)
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GCNConv(8,32, aggr = 'max'),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.1), 'x -> x'),
            (Linear(32,16),'x -> x'),
            nn.ReLU(inplace = True),
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GCNConv(8,128, aggr = 'max'),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.15), 'x -> x'),
            (Linear(128,64),'x -> x'),
            nn.ReLU(inplace = True),
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GATConv(8,32, aggr = 'add', edge_dim = 1),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.1), 'x -> x'),
            (Linear(32,16),'x -> x'),
            nn.ReLU(inplace = True),
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GATConv(8,32, aggr = 'max', edge_dim = 1),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.1), 'x -> x'),
            (Linear(32,16),'x -> x'),
            nn.ReLU(inplace = True),
...
class GCN(torch.nn.Module):
    def __init__(self):
        ...
        self.seq = Sequential('x, edge_index, edge_weight', [
            (GATConv(8,96, aggr = 'max', edge_dim = 1),'x, edge_index, edge_weight -> x'),
            nn.ReLU(inplace = True),
            (nn.Dropout(0.1), 'x -> x'),
            (Linear(96,48),'x -> x'),
            nn.ReLU(inplace = True),
